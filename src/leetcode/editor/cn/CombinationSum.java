...
public class CombinationSum {
    ...
    class Solution {
        ...
        public List<List<Integer>> combinationSum(int[] candidates, int target) {
            travel(candidates, target, new LinkedList<>());
            return ret;
        }

        private void travel(int[] arrays, int target, LinkedList<Integer> item) {
            if (target == 0) {
            ...
            for (int a : arrays) {
                item.push(a);
                travel(arrays, target - a, item);
                item.pop();
            }
        }

        private boolean contains(List<Integer> b) {
            Collections.sort(b);
